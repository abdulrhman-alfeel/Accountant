        ...
        <Pressable
          ...
          <View style={styles.Abdu_body}>
            <Text style={styles.text_Abdu}>
              {localed == 'ar_MA'
                ? 'للاستفسال وطرح المقترحات اتصل بنا'
                : 'For inquiries and suggestions, contact us'}{' '}
            </Text>
            <View>
              <Text style={styles.text_Abdu}>
                {localed == 'ar_MA' ? 'تنفيذ' : 'execution'}
              </Text>
              <Text style={styles.text_Abdu}>
                {localed == 'ar_MA' ? 'م/عبدالرحمن الفيل' : 'Abdulrhman Alfeel'}
              </Text>
            </View>
            <TouchableOpacity
              onPress={() => {
              ...
              <Text style={styles.text_Abdu}>
                {localed == 'ar_MA' ? 'اتصل بنا' : 'Contact Us'}{' '}
              </Text>
            </TouchableOpacity>
            <View
              ...
              <Pressable
                ...
                onPress={() => {
                  Linking.openURL('https://www.facebook.com/hamyk.yayemen');
                }}>
                <FontAwesome5Icon
                  name="facebook"
                  size={25}
              ...
              <Pressable
                ...
                onPress={() => {
                  Linking.openURL(
                    'https://api.whatsapp.com/send/?phone=967718295860',
                  );
                }}>
                <FontAwesome5Icon
                  name="whatsapp"
